...
var CustomButton = function (btn) {
    return (React__default["default"].createElement(Button$1, { style: { width: "40px", height: "40px" }, className: 'custom-button bg-secondary rounded-circle border-0', onClick: function () { return btn.onClickFunction(btn.param); } }, btn.text));
};
...
var CartView = function (_a) {
    ...
    return (React__default["default"].createElement("div", null, cartMode != true ?
        React__default["default"].createElement("div", { className: "d-flex flex-wrap w-100" }, items[0][0].map(function (product) {
            return React__default["default"].createElement(Card$1, { className: "d-flex m-2 p-1", style: { minWidth: "30%" }, key: product.id },
                ...
                React__default["default"].createElement(Card$1.Body, { className: "flex-column p-1" },
                    React__default["default"].createElement("div", { className: "d-flex justify-content-between my-3" },
                        ...
                        React__default["default"].createElement("span", { className: "fs-.5 text-muted" },
                            "\u20B1 ",
                            product.price)),
                    React__default["default"].createElement("div", { className: "d-flex flex-row justify-content-between align-items-center" },
                        React__default["default"].createElement(CustomButton, { text: btnText1, onClickFunction: itemBtnFunction1, param: product }),
                        React__default["default"].createElement("span", { className: "ml-4 mr-4 cart " }, product.quantity),
                        React__default["default"].createElement(CustomButton, { text: btnText2, onClickFunction: itemBtnFunction2, param: product }))));
        }))
        :
